...
<section class="team-detail">
    <div class="container">
        <div class="team-member-detail" id="max">
            <img src="assets/img/gallery/Maxmilian_Hostalek_opt.jpg" alt="Portrét maséra Maxmiliána Hořálka" loading="lazy" decoding="async">
            <div class="info">
                <h2>Maxmilián Hořálek</h2>
                <p class="tagline">Student fyzioterapie · sportovní regenerace a prevence</p>
                <p>Jmenuji se Maxmilián Hořálek a jsem student fyzioterapie s vášní pro aktivní život a komplexní regeneraci. Ve svých 22 letech se neustále vzdělávám v oblasti lidského pohybu a kvalitní masérské péče, abych vám mohl nabídnout to nejlepší.</p>
